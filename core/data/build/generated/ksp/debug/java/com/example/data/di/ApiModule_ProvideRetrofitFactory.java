...
public final class ApiModule_ProvideRetrofitFactory implements Factory<Retrofit> {
  ...
  public static ApiModule_ProvideRetrofitFactory create(Provider<OkHttpClient> okHttpClientProvider,
      Provider<Json> jsonProvider) {
    return new ApiModule_ProvideRetrofitFactory(okHttpClientProvider, jsonProvider);
  }

  public static Retrofit provideRetrofit(OkHttpClient okHttpClient, Json json) {
    return Preconditions.checkNotNullFromProvides(ApiModule.INSTANCE.provideRetrofit(okHttpClient, json));
  }
}
