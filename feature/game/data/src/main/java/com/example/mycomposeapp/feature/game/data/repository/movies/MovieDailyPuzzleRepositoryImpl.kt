...
import com.example.mycomposeapp.feature.game.data.seeder.MovieEmojiPuzzleSeeder
...
class MovieDailyPuzzleRepositoryImpl @Inject constructor(
    ...
    override suspend fun seedPuzzles() {
        ...
        val col = firestore.collection("emoji_puzzles")
        MovieEmojiPuzzleSeeder.ALL.forEach { data ->
